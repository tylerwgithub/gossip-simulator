defmodule Proj2 do
  ...
  def startProgram(nodes, topology, "gossip") do
    :ok = Proj2.NetworkManager.linkNodes(
      case topology do
    ...
    Proj2.GossipNode.startGossip(Enum.random(nodes), [:hello])
  ...
  def startProgram(nodes, topology, "push-sum") do
    :ok = Proj2.NetworkManager.linkNodes(
      case topology do
        "full"   -> &Proj2.Topology.full/1
        "line"   -> &(Proj2.Topology.grid(&1, 1))
